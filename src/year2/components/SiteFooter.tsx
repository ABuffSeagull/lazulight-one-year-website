  ...
  return (
    <>
      <footer className={`${classes.footer} ${classes[`${theme}-footer-border`]}`}>
        ...
        <p>This fan website showcases our thanks and congratulations to LazuLight of Nijisanji EN on their second full year of streaming. Every showcased message, art, music, and game was created specifically for this anniversary event.</p>
        <h4>Thanks:</h4>
