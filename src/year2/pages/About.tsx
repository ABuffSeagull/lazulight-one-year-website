  ...
  return (
    <>
      <Textbox>
        ...
        <p>Fans of LazuLight from across the world and from all walks of life joined together to create this expression of thanks. Every showcased message, art, music, 4-koma, manga, and this website itself was created specifically for this purpose. This project is the culmination of many months of efforts from artists, programmers, writers, and many others.</p>
